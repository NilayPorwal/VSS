...
import {Platform, StyleSheet, Text, View,Linking, Image, TouchableOpacity,ToastAndroid, Dimensions,  
		...
		Modal, TouchableWithoutFeedback, AsyncStorage, ActivityIndicator,CheckBox, WebView} from 'react-native';
...
const {height, width} = Dimensions.get('window');
  ...
  const circleData = [{circle:"Bhratapur Circle", data:[
                      ...
                      {circle:"Sawai Madhopur Circle", data:[
...
type Props = {};   
export default class CircleDetails extends Component<Props> {
   ...
   renderWeightRow(datum) {
        return (
               <View style={{ alignSelf: 'stretch', flexDirection: 'row' }}>
                <View style={{ flex: 1, alignSelf: 'stretch',  alignItems: 'center',borderBottomWidth:1, borderRightWidth:1, borderLeftWidth:1,  paddingVertical:10, backgroundColor:'#ffffff' }} >
                 <Text style={{color:"#000000", textAlign:"center"}}>{datum.Designation}</Text>
                </View> 
                <View style={{ flex: 1, alignSelf: 'stretch', alignItems: 'center', borderBottomWidth:1, borderRightWidth:1, paddingVertical:10, backgroundColor:'#ffffff' }} >
     ...
     <View style={styles.container} >
          <ScrollView  showsVerticalScrollIndicator={false} style={{flex:1, padding:15}} > 
           ...
           <View style={{flexDirection:'row'}}>
            ...
            <View style={{width:'80%'}}> 
             <Text style={{fontSize:18, fontFamily:'GoogleSans-Medium', color:'#FF9966', textAlign:'center' }}>{this.props.navigation.state.params.title}</Text>
            </View>       
           </View> 
            

             <View style={{alignSelf: 'stretch', flexDirection: 'row', marginTop:20 }}>
                <View style={{ flex: 1, alignSelf: 'stretch',  alignItems: 'center', borderWidth:1,  paddingVertical:10, backgroundColor:'#FF9966'}} >
                 <Text style={{fontFamily:'GoogleSans-Medium', color:"#000000", textAlign:"center"}}>Designation and Name of Office</Text> 
                </View>  
                <View style={{ flex: 1, alignSelf: 'stretch',  alignItems: 'center', borderRightWidth:1, borderBottomWidth:1, borderTopWidth:1, paddingVertical:10, backgroundColor:'#FF9966'}} >
