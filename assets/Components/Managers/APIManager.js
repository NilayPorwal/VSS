...
export default class APIManager {
	...
	static getCredentials() {
		AsyncStorage.getItem('ssoId').then(value => {
			if (value != null) {
				APIManager.Sso_Id = value.toString();
			}
		});
		AsyncStorage.getItem('apiSeceretKey').then(value => {
			if (value != null) {
		...
		AsyncStorage.getItem('InspId').then(value => {
			if (value != null) {
	...
	static getAPI() {
		AsyncStorage.getItem('api').then(value => {
			if (value != null) {
