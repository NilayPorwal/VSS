...
export default class MaterialInspected extends Component {
	...
	async setCount() {
		...
		await AsyncStorage.setItem('count', this.state.testCount.toString());
	}
	...
	async removeVendorData() {
		await AsyncStorage.removeItem('insId');
		await AsyncStorage.removeItem('vndrId');
		await AsyncStorage.removeItem('woId');
		await AsyncStorage.removeItem('matId');
		await AsyncStorage.removeItem('matscId');
