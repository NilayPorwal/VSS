...
type Props = {};  
export default class ConfirmInspectionScreen extends Component<Props> {
    ...
    if(this.state.Date == null || this.state.Time == null||this.state.mode === 0 || this.state.location == null){
     ...
     this.setState({isRefreshing:true})
       ...
       //  alert( JSON.stringify(Details) )
        APIManager.onConfirmInsp(Details, 
        (responseJson)=> {
	  ...
	  <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
        ...
        <View style={styles.detailsView}>  
		 ...
		 <View style={{flexDirection:'row', justifyContent:'space-between'}}>
		  ...
		  <View style={{width:'50%'}}>
    	   <Text style={{color:'black', fontFamily:'GoogleSans-Medium', textAlign:'right'}}>Work Order Id</Text>
		   <Text style={{color:'black', textAlign:'right', flex:1,  flexWrap: 'wrap'}}>{this.state.vendorInfo.woCustomUnqId}</Text>
		  </View>
		 </View>     
		 ...
		 <View style={{flexDirection:'row', justifyContent:'space-between', marginTop:15}}>
		  <View style={{width:'50%'}}>
		   ...
		   <Text style={{color:'black', flex:1,  flexWrap: 'wrap'}}>{this.state.vendorInfo.vendorWorksAddress}</Text>
		  </View>
		      
		  <View style={{width:'50%'}}>
    	   <Text style={{color:'black', fontFamily:'GoogleSans-Medium', textAlign:'right'}}>Work Order Date</Text>
		   <Text style={{color:'black', textAlign:'right', flex:1,  flexWrap: 'wrap'}}>{this.state.vendorInfo.woDate}</Text>
		  </View> 
		 </View>  
		 ...
		 <View style={{flexDirection:'row', justifyContent:'space-between', marginTop:15}}>
		  <View style={{width:'50%'}}>
		   ...
		   <Text style={{color:'black', flex:1,  flexWrap: 'wrap'}}>{this.state.vendorInfo.pdiOfferUnqId}</Text>
		  </View>
		 ...
		 <View style={{flexDirection:'row', justifyContent:'space-between', marginTop:15}}>
		  ...
		  <View style={{width:'50%'}}>
		    ...
		    <Text style={{color:'black', textAlign:'right', flex:1,  flexWrap: 'wrap'}}>{this.state.vendorInfo.materialQty}</Text>  
		  </View> 
		 </View>  
