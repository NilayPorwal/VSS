...
import {Platform, StyleSheet, Text, View, Image, TouchableOpacity,
		...
		ActivityIndicator, AsyncStorage, ScrollView, FlatList, TextInput} from 'react-native';
...
type Props = {};  
export default class GenerateSiteOffer extends Component<Props> {
  ...
  async getVendorId(){  
		 await AsyncStorage.getItem('InspId').then((value) => 
			this.setState({vndId:value},()=>{this.getVendorInfo(); this.getWorkOrderDetails()} )	
		 )         
	 } 
  ...
  getVendorInfo(){  
    ...
    getWorkOrderDetails(){  
          APIManager.getWorkOrderDetails(this.state.vndId, 
        (responseJson)=> {    
	         //alert(JSON.stringify(responseJson));
	         if (responseJson.status == 'SUCCESS'){ 
  ...
  render() {    
    ...
    return (
      ...
      <View style={{width:'80%'}}> 
       <Text style={{fontSize:18, fontFamily:'GoogleSans-Medium', color:'black', paddingTop:15, textAlign:'center' }}>REQUEST SITE OFFER</Text>
      </View>  
     </View> 
        ...
        <View style={styles.detailsView}>  
		 ...
		 <View style={{flexDirection:'row', justifyContent:'space-between'}}>
		  ...
		  <View style={{width:'50%'}}>
    	   <Text style={{color:'black', fontFamily:'GoogleSans-Medium', textAlign:'right'}}>Tender No.</Text>
		   <Text style={{color:'black', textAlign:'right', flex:1,  flexWrap: 'wrap'}}>{this.state.woDetails.tenderNumber}</Text>
		  </View>
		 </View>     
		 ...
		 <View style={{flexDirection:'row', justifyContent:'space-between', marginTop:20}}>
		  <View style={{width:'50%'}}>
		   ...
		   <Text style={{color:'black', flex:1,  flexWrap: 'wrap'}}>{this.state.woDetails.inspectorName}</Text>
		  </View>
		  ...
		  <View style={{width:'50%'}}>
		   ...
		   <Text style={{color:'black', textAlign:'right', flex:1,  flexWrap: 'wrap'}}>{this.state.woDetails.materialName}</Text>
			...
			<View style={{flexDirection:'row', marginTop:10}}>
			  <View style={{width:'50%'}}>
			    <Text style={{color:'#000000', fontFamily:'GoogleSans-Medium', fontSize:15}}>Supply Quantity</Text>
			    <Text style={{color:'#000000',  fontSize:13}}>{this.state.woDetails.deliverySchQty}</Text>
			  </View> 
			  
			  <View  style={{width:'50%'}}> 
			    <Text  style={{color:'#000000', fontFamily:'GoogleSans-Medium', fontSize:15, textAlign:'right'}}>Offer Quantity</Text>
			    <Text  style={{color:'#000000', fontSize:13, textAlign:'right'}}>{this.state.woDetails.offerQty}</Text>
			  </View> 
			</View>      
		</View>   
       ...
       <View style={{margin:15, borderRadius:5, elevation:8, backgroundColor:'#ffffff', padding:15}}>
          ...
          <View style={{flexDirection:'row', marginTop:10}}>
             ...
             <View style={{width:'50%'}}>
			   <Text style={{color:'#000000', fontFamily:'GoogleSans-Medium', paddingTop:5}}>Total Package No.</Text>
			  </View> 
			 ...
			 <View style={{flexDirection:'row', marginTop:10}}>
			  <View style={{width:'50%'}}>
			   <Text style={{color:'#000000', fontFamily:'GoogleSans-Medium', paddingTop:5}}>Quantity Per Package</Text>
			  </View> 
		  ...
		  <View style={{backgroundColor:'#eeeeee', padding:10, marginTop:10}}>
           <Text style={{color:'#000000', fontFamily:'GoogleSans-Medium', fontSize:15}}>Package Wise Details</Text>
          </View>
          ...
          <View style={{flexDirection:'row', marginTop:10}}>
             ...
             <View style={{width:'50%'}}>
			   <Text style={{color:'#000000', fontFamily:'GoogleSans-Medium', paddingTop:5}}>Package Start Serial No.</Text>
			  </View> 
			 ...
			 <View style={{flexDirection:'row', marginTop:10}}>
			  <View style={{width:'50%'}}>
			   <Text style={{color:'#000000', fontFamily:'GoogleSans-Medium', paddingTop:5}}>Material Start Serial No.</Text>
			  </View> 
          ...
          <TouchableOpacity  onPress={()=>this.createPDF()}  style={{borderRadius: 5, backgroundColor: '#418bca', marginTop:10}}>
			<Text style={{fontSize:15, color:'#ffffff', fontFamily:'GoogleSans-Medium', paddingVertical:10, textAlign:'center',  elevation:5}}>Generate Site Offer</Text>
		  </TouchableOpacity> 
