...
type Props = {};
export default class BecStandards extends Component<Props> {
	...
	<ScrollView>  
      <View style={styles.container}>
	   ...
	   <View style={{borderWidth:1, margin:15}}>
		...
		<Text style={{color:'black', fontFamily:'GoogleSans-Medium', paddingLeft:15, paddingTop:15}}>BEC STANDARDS FOR</Text>
...
const styles = StyleSheet.create({
  container: {
	...
	tableContentText:{
	 padding:10,  color:'#141F25', borderRightColor:'lightgrey', textAlign:'center', borderRightWidth:1,	fontSize:12
	},
	button:{
     borderRadius: 5, backgroundColor: '#ff7f00',  marginVertical:20		
	},  
	  
	buttonText:{
     fontSize:15, color:'black', fontFamily:'GoogleSans-Medium', paddingHorizontal:25, paddingVertical:10		
	},
    detailsView:{
