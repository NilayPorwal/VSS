...
import {Platform, StyleSheet, Text, View, Image, TouchableOpacity,BackHandler, ScrollView, Modal, TextInput,TouchableWithoutFeedback, KeyboardAvoidingView, ImageBackground} from 'react-native';
...
type Props = {};  
export default class DrawingTest extends Component<Props> {
	...
	onPassTest(){
	  this.setState({status:"Pass"},()=>{ this.uploadDrawing()})
		
	}
	onFailTest(){
	  this.setState({status:"Fail"},()=>{ this.uploadDrawing()})		
	}        
    ...
    <ScrollView>	
     <View style={styles.container}>
		...
		<Text style={{fontSize:20, fontFamily:'GoogleSans-Medium', marginTop:25, color:'black'}}>Test As Per Approved Drawing</Text>
	   ...
	   <View style={{borderWidth:1, marginLeft:15, marginRight:15, padding:15,  alignItems:'center', backgroundColor:'orange', width:'90%'}}>
	    ...
	    <Text style={{fontSize:15, fontFamily:'GoogleSans-Medium', paddingTop:10, color:'black'}}>Click to Download Approved Drawing</Text>
       </View>
        
		  
       	<View style={{ width:'100%', padding:15}}>
		  <Text style={{fontSize:18, fontFamily:'GoogleSans-Medium', paddingTop:10, color:'black', textAlign:'center'}}>OBSERVATIONS</Text>	 
		  <TextInput
...
const styles = StyleSheet.create({
  container: {
    ...
    button:{
     borderWidth:1, borderRadius: 5, backgroundColor: 'green', borderColor:'red'		
	},
	buttonText:{
