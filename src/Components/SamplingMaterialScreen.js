...
export default class SamplingMaterial extends Component {
	constructor(props) {
		super(props);
		this.state = {
			siteOfferDetails: {},
					...
					<View style={styles.container}>
						...
						<View style={styles.detailsView}>
							...
							{this.state.siteOfferDetails.withPackingList == 'Y' ? (
								...
								>
									<Text style={{ color: 'black', fontFamily: 'GoogleSans-Medium', marginBottom: 15 }}>
										Material Serial No.
									</Text>
									<View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
										<Text>From</Text>
							...
							<View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 15 }}>
								...
								<View style={{ flexDirection: 'row' }}>
									<Text style={{ fontFamily: 'GoogleSans-Medium', fontSize: 20, color: 'brown' }}>
										{this.state.siteOfferDetails.samplingRatio}
									</Text>

									<TouchableOpacity
										onPress={() =>
											this.props.navigation.push('EditSamplingRatio', {
						...
						<View style={{ justifyContent: 'center', alignItems: 'center' }}>
							<TouchableOpacity onPress={() => this.uploadTestStatus()} style={styles.button}>
								{this.state.isLoading == false ? (
									<Text style={{ fontSize: 18, color: '#ffffff', fontFamily: 'GoogleSans-Medium' }}>
										START INSPECTION
									</Text>
								) : (
