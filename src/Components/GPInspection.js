...
global.GPInspection;
export default class GPInspection extends Component {
	constructor(props) {
		super(props);
		this.state = {
			screenType: 'Other',
									...
									<View style={{ width: 300, height: 200, backgroundColor: '#ffffff', padding: 10, borderRadius: 10 }}>
										...
										<View style={{ marginTop: 50 }}>
											<Text style={{ color: 'black', fontSize: 15, textAlign: 'center' }}>
												{global.GPInspection.state.workAddress}
											</Text>
										</View>
									</View>
								</TouchableWithoutFeedback>
