...
export default class PDIOfferScreen extends Component {
	constructor(props) {
		super(props);
		this.state = {
			vendorInfo: {},
						...
						<View style={styles.detailsView}>
							<View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
								...
								<View style={{ width: '50%' }}>
									...
									<Text style={{ color: 'black', textAlign: 'right', flex: 1, flexWrap: 'wrap' }}>
										{this.state.vendorInfo.ownerMobile}
									</Text>
								</View>
							</View>
							...
							<View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 20 }}>
								...
								<View style={{ width: '50%' }}>
									...
									<Text style={{ color: 'black', textAlign: 'right', flex: 1, flexWrap: 'wrap' }}>
										{this.state.vendorInfo.contactPersonName}
									</Text>
								</View>
							</View>
						</View>
								...
								renderItem={({ item, index }) => (
									<View
										style={[
											...
											{
												borderLeftColor:
													typeof item.scheduleAdd == 'undefined' || item.scheduleAdd == 'Y' ? '#61B865' : '#E63E3A'
											}
										]}
									>
