...
export default class SamplingList extends Component {
						...
						<View style={{ borderWidth: 1, margin: 15, alignItems: 'center' }}>
							<View style={{ borderWidth: 1, padding: 15, backgroundColor: 'black', width: '100%', marginTop: 20 }}>
								<View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
									<View>
										<Text style={{ color: 'white', fontFamily: 'GoogleSans-Medium', fontSize: 18 }}>
											Total Quantity
										</Text>
									...
									<View>
										<Text style={{ color: 'white', fontFamily: 'GoogleSans-Medium', fontSize: 18, textAlign: 'right' }}>
											Sampling Quantity
										</Text>
										<Text style={{ color: 'white', fontFamily: 'GoogleSans-Medium', fontSize: 18, textAlign: 'right' }}>
											23
							...
							<View style={{ borderWidth: 1, margin: 15, padding: 15, backgroundColor: '#fe9900', width: '90%' }}>
								<Text style={{ color: 'black', fontFamily: 'GoogleSans-Medium', marginBottom: 15, fontSize: 18 }}>
									Material
								</Text>
