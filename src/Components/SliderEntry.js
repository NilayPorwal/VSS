				...
				{index === 0 || index === 3 || index === 6 ? (
					...
					>
						...
						>
							...
							<TouchableOpacity
								onPress={() => this.props.navigate('AboutUsScreen')}
								style={{
									backgroundColor: '#EC7E41',
									padding: 15,
									borderRadius: 50,
									marginTop: 25,
							...
							>
								<Text style={{ color: '#ffffff', fontFamily: 'GoogleSans-Medium', fontSize: 15, textAlign: 'center' }}>
									{' '}
									About Us{' '}
								</Text>
							</TouchableOpacity>
				...
				{index === 1 || index === 4 || index === 7 ? (
					...
					>
						...
						>
							...
							<TouchableOpacity
								onPress={() => this.props.navigate('SignUpScreen')}
								style={{
									backgroundColor: '#EC7E41',
									padding: 15,
									borderRadius: 50,
