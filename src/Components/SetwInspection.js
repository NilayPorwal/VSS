...
global.SetwInspection;
export default class SetwInspection extends Component {
	constructor(props) {
		super(props);
		this.state = {
			firstName: '',
						...
						{this.state.roleName == 'INSPECTOR' && this.state.isRefreshing == false ? (
							<View>
								<View style={{ flexDirection: 'row', width: '90%', marginTop: 30 }}>
									<TouchableOpacity
										onPress={() =>
											this.props.navigation.push('InspectionsPerformed', {
												from: 'setw'
											})
										}
									...
									<TouchableOpacity
										onPress={() => this.props.navigation.push('InspectionsInProcess', { from: 'setw' })}
										style={{ width: '50%', justifyContent: 'center', alignItems: 'center' }}
									>
										<Image
								...
								<View style={{ flexDirection: 'row', width: '90%', marginTop: 30 }}>
									<TouchableOpacity
										onPress={() => this.props.navigation.push('NominationConfirmation', { from: 'setw' })}
										style={{ width: '50%', justifyContent: 'center', alignItems: 'center' }}
									>
										<Image
