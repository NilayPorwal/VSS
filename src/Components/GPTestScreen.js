		...
		return (
			<ImageBackground source={require('../Images/background.png')} style={{ flex: 1 }}>
				...
				<ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
					<KeyboardAvoidingView behavior="position" keyboardVerticalOffset={Platform.OS === 'ios' ? 40 : 50}>
						...
						>
							<View style={{ flexDirection: 'row', marginVertical: 5 }}>
								...
								<Text
									...
									selectable={true}
								>
									{this.state.vendorDetails.vendorFirmName}
								</Text>
							</View>
							...
							<View style={{ flexDirection: 'row', marginTop: 15 }}>
								<View style={{ width: '50%' }}>
									...
									<Text style={{ color: '#000000', fontFamily: 'GoogleSans-Medium', paddingTop: 5 }}>
										{this.state.vendorDetails.materialName}
									</Text>
								</View>
								<View style={{ width: '50%' }}>
									<Text style={{ color: '#000000', textAlign: 'right' }}>Subcategory Name</Text>
									<Text
										style={{ color: '#000000', fontFamily: 'GoogleSans-Medium', paddingTop: 5, textAlign: 'right' }}
									>
										{this.state.vendorDetails.materialScName}
									</Text>
								</View>
							</View>
						</View>
						...
						>
							<View style={{ alignItems: 'center' }}>
								...
								>
									Click to Scan and Upload Observation Documents (if any)
								</Text>
					...
					>
						...
						<TouchableOpacity
							...
							style={{ ...styles.button, backgroundColor: '#fb0102' }}
						>
