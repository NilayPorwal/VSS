...
export default class GPConfirmInspectionScreen extends Component {
	constructor(props) {
		super(props);
		this.state = {
						...
						<View style={styles.detailsView}>
							...
							<View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 15 }}>
								<View style={{ width: '50%' }}>
									...
									<Text style={{ color: 'black', flex: 1, flexWrap: 'wrap' }}>
										{this.state.vendorInfo.vendorWorkAddress}
									</Text>
								</View>
								...
								<View style={{ width: '50%' }}>
									...
									<Text style={{ color: 'black', textAlign: 'right', flex: 1, flexWrap: 'wrap' }}>
										{this.state.vendorInfo.nominatioDateTime}
									</Text>
								</View>
							</View>
							...
							<View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 15 }}>
								...
								<View style={{ width: '50%' }}>
									...
									<Text style={{ color: 'black', textAlign: 'right', flex: 1, flexWrap: 'wrap' }}>
										{this.state.vendorInfo.offerQty}
									</Text>
								</View>
							</View>
						</View>
